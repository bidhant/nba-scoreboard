...
class Tracker:
    ...
    def get_object_tracks(self, frames, read_from_stub = False, stub_path = None):
        ...
        for frame_num, detection in enumerate(detections):
            ...
            cls_names_inv = {value:key for key, value in cls_name.items()}
            ...
            for frame_detection in detection_with_tracks: 
                ...
                # you can add the tracker for the ball as well.
                # just remove the for loop below and replace it with the if cls_id == cls_names_inv['ball'] and continue
